...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\SzzsRepository")
 * @ORM\Table(name="szzs",indexes={
 *              @ORM\Index(name="date_idx",columns={"date"}),
 *              @ORM\Index(name="opening_ratio_idx",columns={"opening_ratio"}),
 *              @ORM\Index(name="pre_three_two_one_opening_idx",columns={"pre_count","pre_two_count","pre_three_count","count","opening_ratio"}),
 *              @ORM\Index(name="pre_two_one_opening_idx",columns={"pre_count","pre_two_count","count","opening_ratio"}),
 *              @ORM\Index(name="pre_three_two_opening_idx",columns={"pre_count","pre_two_count","pre_three_count","opening_ratio"})
 * })
 */
class Szzs
{
