 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ZbgfRepository")
 * @ORM\Table(name="zbgf",options={"comment":"志邦股份数据表"},indexes={@ORM\Index(name="date_idx",columns={"date"}),
